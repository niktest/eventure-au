      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 sm:px-12 lg:w-1/2 lg:px-24 xl:px-32 bg-surface-bright">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-4 mb-8">
            <button
              type="button"
              className="flex w-full items-center justify-center gap-3 rounded-full border-2 border-outline bg-transparent px-4 py-3 font-body text-sm font-semibold text-on-surface transition-all hover:bg-surface hover:border-primary hover:text-primary"
            >
          ...
          <form className="space-y-5">
            <div>
              <label htmlFor="name" className="block font-body text-sm font-semibold text-on-surface mb-1">
                Full Name
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full rounded-lg border border-outline bg-surface py-3 pl-10 pr-3 font-body text-base text-on-surface placeholder:text-outline-variant focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                />
              </div>
            </div>

            <div>
              <label htmlFor="email" className="block font-body text-sm font-semibold text-on-surface mb-1">
                Email Address
              </label>
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
            ...
            <div>
              <label htmlFor="password" className="block font-body text-sm font-semibold text-on-surface mb-1">
                Password
              </label>
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
            ...
            <button
              type="submit"
              className="mt-8 flex w-full justify-center rounded-full bg-primary px-4 py-3.5 font-body text-sm font-semibold text-on-primary shadow-sm hover:bg-primary-container hover:text-on-primary-container hover:scale-[1.02] transition-all"
            >
              Create Account
            </button>
          </form>
        ...
        <div className="absolute bottom-0 left-0 z-20 p-12 xl:p-24 w-full">
          <div className="inline-block bg-primary-container/90 backdrop-blur-md rounded-2xl p-6 shadow-lg max-w-md">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-body text-xs font-semibold text-on-primary-container uppercase tracking-wider">
                Premium Experience
              </span>
            </div>
            <p className="font-heading text-xl font-bold text-on-primary-container">
