        ...
        <div className="w-full max-w-[440px]">
          ...
          <fieldset className="border-0 p-0 m-0">
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 py-3 px-6 bg-transparent border-2 border-secondary text-secondary rounded-full font-body text-sm font-semibold hover:bg-surface-container-low transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
              >
